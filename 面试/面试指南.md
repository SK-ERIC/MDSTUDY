## [#](https://interview2.poetries.top/docs/guide.html#一、准备-简历编写和面试前准备)一、准备：简历编写和面试前准备
...
### [#](https://interview2.poetries.top/docs/guide.html#promise)Promise
...
![img](https://cos.poetries.work/gitee/2020/07/guide/1.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/2.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/3.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/4.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/5.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/6.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/7.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/8.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/9.png)

> 加上`float:left`之后：

![img](https://cos.poetries.work/gitee/2020/07/guide/10.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/11.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/12.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/13.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/14.png)

> 然后，我们把第三个`<p>`改为`position:absolute;`，看看会发生什么变化。

![img](https://cos.poetries.work/gitee/2020/07/guide/15.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/16.png)

> `fixed` 元素的定位是相对于 `window` （或者 `iframe`）边界的，和其他元素没有关系。但是它具有破坏性，会导致其他元素位置的变化。

![img](https://cos.poetries.work/gitee/2020/07/guide/17.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/18.png) ![img](https://cos.poetries.work/gitee/2020/07/guide/19.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/20.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/21.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/22.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/23.png)
...
![img](https://cos.poetries.work/gitee/2020/07/guide/24.png)
...
### [#](https://interview2.poetries.top/docs/guide.html#前端常遇见的数据结构问题)前端常遇见的数据结构问题
...
### [#](https://interview2.poetries.top/docs/guide.html#算法的效率是通过算法复杂度来衡量的)算法的效率是通过算法复杂度来衡量的
...
### [#](https://interview2.poetries.top/docs/guide.html#人人都要掌握的基础算法)人人都要掌握的基础算法
...
### [#](https://interview2.poetries.top/docs/guide.html#快排和二分查找)快排和二分查找
...
### [#](https://interview2.poetries.top/docs/guide.html#面试遇见不会的算法问题怎么办)面试遇见不会的算法问题怎么办
...
### [#](https://interview2.poetries.top/docs/guide.html#正则匹配解题)正则匹配解题
...
- 这个题目可以用算法直接来解，如果候选人使用正则来回答，这样主动展现了自己其他方面的优势，即使不是算法解答出来的，面试官一般也不会太难为他。这道题目可以利用正则的「零宽断言」`(?=exp)`，意思是它断言自身出现的位置的后面能匹配表达式 exp。数字千分位的特点是，第一个逗号后面数字的个数是 3 的倍数，正则：`/(\d{3})+$/`；第一个逗号前最多可以有 1~3 个数字，正则：`/\d{1,3}/`。加起来就是`/\d{1,3}(\d{3})+$/`，分隔符要从前往后加。
...
### [#](https://interview2.poetries.top/docs/guide.html#小结-3)小结
...
## [#](https://interview2.poetries.top/docs/guide.html#六、一面-5-浏览器相关知识点与高频考题解析)六、一面 5：浏览器相关知识点与高频考题解析

> `Web` 前端工程师写的页面要跑在浏览器里面，所以面试中也会出现很多跟浏览器相关的面试题目。

### [#](https://interview2.poetries.top/docs/guide.html#知识点梳理-5)知识点梳理
...
### [#](https://interview2.poetries.top/docs/guide.html#加载页面和渲染过程)加载页面和渲染过程
...
![img](https://cos.poetries.work/gitee/2020/07/guide/25.png)
...
### [#](https://interview2.poetries.top/docs/guide.html#性能优化)性能优化
...
### [#](https://interview2.poetries.top/docs/guide.html#详细解释)详细解释
...
### [#](https://interview2.poetries.top/docs/guide.html#web-安全)Web 安全
...
- CSRF 的发生其实是借助了一个 cookie 的特性。我们知道，登录了`http://buy.com`之后，cookie 就会有登录过的标记了，此时请求`http://buy.com/pay?touid=999&money=100`是会带着 cookie 的，因此 server 端就知道已经登录了。而如果在`http://buy.com`去请求其他域名的 API 例如`http://abc.com/api`时，是不会带 cookie 的，这是浏览器的同源策略的限制。但是 —— **此时在其他域名的页面中，请求http://buy.com/pay?touid=999&money=100，会带着buy.com的 cookie ，这是发生 CSRF 攻击的理论基础。**

> 预防 `CSRF` 就是加入各个层级的权限验证，例如现在的购物网站，只要涉及现金交易，肯定要输入密码或者指纹才行。除此之外，敏感的接口使用`POST`请求而不是`GET`也是很重要的。

## [#](https://interview2.poetries.top/docs/guide.html#七、一面-6-开发环境相关知识点与高频考题解析)七、一面 6：开发环境相关知识点与高频考题解析

### [#](https://interview2.poetries.top/docs/guide.html#知识点梳理-6)知识点梳理
...
### [#](https://interview2.poetries.top/docs/guide.html#ide)IDE
...
### [#](https://interview2.poetries.top/docs/guide.html#git)Git
...
### [#](https://interview2.poetries.top/docs/guide.html#关于-svn)关于 SVN
...
### [#](https://interview2.poetries.top/docs/guide.html#linux-基础命令)Linux 基础命令
...
### [#](https://interview2.poetries.top/docs/guide.html#前端构建工具)前端构建工具
...
### [#](https://interview2.poetries.top/docs/guide.html#调试方法)调试方法
...
![img](https://cos.poetries.work/gitee/2020/07/guide/26.png)

### [#](https://interview2.poetries.top/docs/guide.html#小结-4)小结

> 本小节总结了前端开发环境常考查的知识，这些知识也是前端程序员必须掌握的，否则会影响开发效率。

## [#](https://interview2.poetries.top/docs/guide.html#八、二面-1-如何回答常见的软技能问题)八、二面 1：如何回答常见的软技能问题

> 面试是个技术活，不仅仅是技术，各种软技能的面试技巧也是非常重要的，尤其是程序员一般对于自己的软技能不是很看重，其实**软技能才是决定你职场能够走多远的关键**。

### [#](https://interview2.poetries.top/docs/guide.html#程序员应该具备的软技能)程序员应该具备的软技能
...
### [#](https://interview2.poetries.top/docs/guide.html#常见的软技能问题和提升)常见的软技能问题和提升
...
### [#](https://interview2.poetries.top/docs/guide.html#小结-5)小结

本小节介绍了程序员除了业务技术能力之外应该日常修炼的软技能，在面试中，软技能会被以各种形式问起，候选人应该先了解有哪些软技能可以修炼，才能在回答软技能问题的时候，尽量提到自己具备的软技能。

## [#](https://interview2.poetries.top/docs/guide.html#九、二面-2-如何介绍项目及应对项目细节追问)九、二面 2：如何介绍项目及应对项目细节追问
...
### [#](https://interview2.poetries.top/docs/guide.html#怎样介绍自己做过的一个项目)怎样介绍自己做过的一个项目
...
### [#](https://interview2.poetries.top/docs/guide.html#没有做过大型项目怎么办)没有做过大型项目怎么办
...
### [#](https://interview2.poetries.top/docs/guide.html#项目细节和技术点的追问)项目细节和技术点的追问
...
### [#](https://interview2.poetries.top/docs/guide.html#小结-6)小结

- 本小节介绍了面试中关于项目类问题的回答方法，介绍项目要使用四段体的方式，从背景、承担角色、收益效果和总结反思四个部分来介绍项目。
- 准备这个面试环节的时候，利用笔者一直提倡的「思维导图」法，好好回顾和梳理自己的项目。

## [#](https://interview2.poetries.top/docs/guide.html#十、hr-面-谈钱不伤感情)十、HR 面：谈钱不伤感情
...
### [#](https://interview2.poetries.top/docs/guide.html#匹配度考查)匹配度考查
...
### [#](https://interview2.poetries.top/docs/guide.html#谈薪资)谈薪资
...
### [#](https://interview2.poetries.top/docs/guide.html#准确定位和自我估值)准确定位和自我估值
...
### [#](https://interview2.poetries.top/docs/guide.html#跟-hr-沟通的技巧)跟 HR 沟通的技巧
...
## [#](https://interview2.poetries.top/docs/guide.html#十一、其他-面试注意事项)十一、其他：面试注意事项

> 除了前面小节中提到的一些面试中应该注意的问题，本小节再整理一些面试中应该注意的事项。

### [#](https://interview2.poetries.top/docs/guide.html#注意社交礼仪)注意社交礼仪

虽然说 IT 行业不怎么注重工作环境，上下级也没有繁文缛节，但是在面试中还是应该注意一些社交礼仪的。像进门敲门、出门关门、站着迎人这类基本礼仪还是要做的。

### [#](https://interview2.poetries.top/docs/guide.html#舒适但不随意的着装)舒适但不随意的着装

首先着装方面，不要太随意，也不要太正式，太正式的衣服可能会使人紧张，所以建议穿自己平时喜欢的衣服，关键是干净整洁。

### [#](https://interview2.poetries.top/docs/guide.html#约个双方都舒服的面试时间)约个双方都舒服的面试时间

如果 HR 打电话预约面试时间，记得一定要约个双方都舒服的时间，宁愿请假也要安排好面试时间。

> 有个 case：前几天有个朋友说为了给公司招人，晚上住公司附近酒店，原因是候选人为了不耽误现在公司的工作，想在 10 点之前按时上班，预约的面试时间是早上 8 点。这样对于面试官来说增加了负担，心里肯定不会特别舒服，可能会影响候选人的面试结果。

面试时间很重要，**提前十分钟到面试地点**，熟悉下环境，做个登记之类的，留下个守时的好印象。如果因为堵车之类的原因不能按时到达，则要在约定时间之前电话通知对方。

### [#](https://interview2.poetries.top/docs/guide.html#面试后的提问环节)面试后的提问环节
...
### [#](https://interview2.poetries.top/docs/guide.html#面试禁忌)面试禁忌
...
### [#](https://interview2.poetries.top/docs/guide.html#最好自己带电脑)最好自己带电脑
...
### [#](https://interview2.poetries.top/docs/guide.html#面试后的总结和思考)面试后的总结和思考
...
## [#](https://interview2.poetries.top/docs/guide.html#十二、总结)十二、总结

### [#](https://interview2.poetries.top/docs/guide.html#准备阶段)准备阶段
...
### [#](https://interview2.poetries.top/docs/guide.html#技术面部分)技术面部分

> 集中梳理了 ECMAScript 基础、JS-Web-API、CSS 和 HTML、算法、浏览器和开发环境六大部分内容，并且就一些高频考题进行讲解。

### [#](https://interview2.poetries.top/docs/guide.html#非技术面试部分)非技术面试部分
...
### [#](https://interview2.poetries.top/docs/guide.html#hr-面)HR 面
...
### [#](https://interview2.poetries.top/docs/guide.html#补充说明)补充说明
...
### [#](https://interview2.poetries.top/docs/guide.html#node-js部分)Node.js 部分
...
### [#](https://interview2.poetries.top/docs/guide.html#前端框架-库)前端框架（库）
...
### [#](https://interview2.poetries.top/docs/guide.html#移动开发)移动开发
