## [#](https://interview2.poetries.top/docs/performance.html#一、前言)一、前言

### [#](https://interview2.poetries.top/docs/performance.html#知识体系-从一道面试题说起)知识体系： 从一道面试题说起
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/1.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#从原理到实践-各个击破)从原理到实践：各个击破
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/2.png)

## [#](https://interview2.poetries.top/docs/performance.html#二、网络篇-1-webpack-性能调优与-gzip-原理)二、网络篇 1：webpack 性能调优与 Gzip 原理
...
### [#](https://interview2.poetries.top/docs/performance.html#webpack-的性能瓶颈)webpack 的性能瓶颈
...
### [#](https://interview2.poetries.top/docs/performance.html#webpack-优化方案)webpack 优化方案
...
### [#](https://interview2.poetries.top/docs/performance.html#构建结果体积压缩)构建结果体积压缩
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/3.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#gzip-压缩原理)Gzip 压缩原理
...
## [#](https://interview2.poetries.top/docs/performance.html#三、网络篇-2-图片优化-质量与性能的博弈)三、网络篇 2：图片优化——质量与性能的博弈
...
### [#](https://interview2.poetries.top/docs/performance.html#_2018-年-图片依然很大)2018 年，图片依然很大
...
![img](https://img.poetries.top/static/gitee/2020/09/109.png)

而具体到**图片**这一类的资源，平均请求体积是这样的：

![img](https://img.poetries.top/static/gitee/2020/09/110.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#不同业务场景下的图片方案选型)不同业务场景下的图片方案选型
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/4.png)

京东首页也不例外：

![img](https://img.poetries.top/static/gitee/2020/07/performance/5.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/6.png)

较小的 Logo：

![img](https://img.poetries.top/static/gitee/2020/07/performance/7.png)

颜色简单、对比度较强的透明小图也在 PNG 格式下有着良好的表现：

![img](https://img.poetries.top/static/gitee/2020/07/performance/8.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/9.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/10.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/11.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/12.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/13.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#小结)小结
...
## [#](https://interview2.poetries.top/docs/performance.html#四、存储篇-1-浏览器缓存机制介绍与缓存策略剖析)四、存储篇 1：浏览器缓存机制介绍与缓存策略剖析
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/14.png)

我们给 `size` 这一栏一个特写：

![img](https://img.poetries.top/static/gitee/2020/07/performance/15.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#http-缓存机制探秘)HTTP 缓存机制探秘
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/16.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/17.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/18.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/19.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#http-缓存决策指南)HTTP 缓存决策指南
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/20.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#memorycache)MemoryCache
...
### [#](https://interview2.poetries.top/docs/performance.html#service-worker-cache)Service Worker Cache
...
### [#](https://interview2.poetries.top/docs/performance.html#push-cache)Push Cache
...
### [#](https://interview2.poetries.top/docs/performance.html#小结-2)小结
...
## [#](https://interview2.poetries.top/docs/performance.html#五、存储篇-2-本地存储-从-cookie-到-web-storage、indexdb)五、存储篇 2：本地存储——从 Cookie 到 Web Storage、IndexDB
...
### [#](https://interview2.poetries.top/docs/performance.html#故事的开始-从-cookie-说起)故事的开始：从 Cookie 说起
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/21.png)

如大家所见，**Cookie 以键值对的形式存在**。

### [#](https://interview2.poetries.top/docs/performance.html#cookie的性能劣势)Cookie 的性能劣势
...
### [#](https://interview2.poetries.top/docs/performance.html#向前一步-web-storage)向前一步：Web Storage
...
### [#](https://interview2.poetries.top/docs/performance.html#应用场景)应用场景
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/22.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/23.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#终极形态-indexdb)终极形态：IndexDB
...
### [#](https://interview2.poetries.top/docs/performance.html#小结-3)小结
...
## [#](https://interview2.poetries.top/docs/performance.html#六、cdn-的缓存与回源机制解析)六、CDN 的缓存与回源机制解析

### [#](https://interview2.poetries.top/docs/performance.html#cdn的缓存与回源机制解析)CDN 的缓存与回源机制解析

> CDN （Content Delivery Network，即内容分发网络）指的是一组分布在各个地区的服务器。这些服务器存储着数据的副本，因此服务器可以根据哪些服务器与用户距离最近，来满足数据的请求。 CDN 提供快速服务，较少受高流量影响。

### [#](https://interview2.poetries.top/docs/performance.html#为什么要用-cdn)为什么要用 CDN
...
### [#](https://interview2.poetries.top/docs/performance.html#cdn-如何工作)CDN 如何工作

借中国地图一角来给大家举一个简单的 🌰：

![img](https://img.poetries.top/static/gitee/2020/07/performance/24.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#cdn的核心功能特写)CDN 的核心功能特写
...
### [#](https://interview2.poetries.top/docs/performance.html#cdn-与前端性能优化)CDN 与前端性能优化
...
### [#](https://interview2.poetries.top/docs/performance.html#cdn-的实际应用)CDN 的实际应用
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/25.png)

我们点击 preview，可以看到业务服务器确实是返回给了我们一个尚未被静态资源加持过的简单 HTML 页面，所有的图片内容都是先以一个 div 占位：

![img](https://img.poetries.top/static/gitee/2020/07/performance/26.png)

相应地，我们随便点开一个静态资源，可以看到它都是从 CDN 服务器上请求来的。

比如说图片：

![img](https://img.poetries.top/static/gitee/2020/07/performance/27.png)

再比如 JS、CSS 文件：

![img](https://img.poetries.top/static/gitee/2020/07/performance/28.png) ![img](https://img.poetries.top/static/gitee/2020/07/performance/29.png)

### [#](https://interview2.poetries.top/docs/performance.html#cdn-优化细节)CDN 优化细节
...
## [#](https://interview2.poetries.top/docs/performance.html#七、渲染篇-1-服务端渲染的探索与实践)七、渲染篇 1：服务端渲染的探索与实践
...
### [#](https://interview2.poetries.top/docs/performance.html#服务端渲染的运行机制)服务端渲染的运行机制
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/30.png)

> zhihu.com 返回的 HTML 文件已经是可以直接进行渲染的内容了。

### [#](https://interview2.poetries.top/docs/performance.html#服务端渲染解决了什么性能问题)服务端渲染解决了什么性能问题
...
### [#](https://interview2.poetries.top/docs/performance.html#服务端渲染的应用实例)服务端渲染的应用实例
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/31.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#服务端渲染的应用场景)服务端渲染的应用场景
...
## [#](https://interview2.poetries.top/docs/performance.html#八、渲染篇-2-知己知彼-解锁浏览器背后的运行机制)八、渲染篇 2：知己知彼——解锁浏览器背后的运行机制
...
### [#](https://interview2.poetries.top/docs/performance.html#浏览器的-心)浏览器的“心”
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/32.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#开启浏览器渲染-黑盒)开启浏览器渲染“黑盒”

什么是渲染过程？简单来说，渲染引擎根据 HTML 文件描述构建相应的数学模型，调用浏览器各个零部件，从而将网页资源代码转换为图像结果，这个过程就是渲染过程（如下图）。

![img](https://img.poetries.top/static/gitee/2020/07/performance/33.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#浏览器渲染过程解析)浏览器渲染过程解析

> 有了对零部件的了解打底，我们就可以一起来走一遍浏览器的渲染流程了。在浏览器里，每一个页面的首次渲染都经历了如下阶段（图中箭头不代表串行，有一些操作是并行进行的，下文会说明）：

![img](https://img.poetries.top/static/gitee/2020/07/performance/34.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#几棵重要的-树)几棵重要的“树”

上面的内容没有理解透彻？别着急，我们一起来捋一捋这个过程中的重点——树！

为了使渲染过程更明晰一些，我们需要给这些”树“们一个特写:

![img](https://img.poetries.top/static/gitee/2020/07/performance/35.png)
...
## [#](https://interview2.poetries.top/docs/performance.html#不做无用功-基于渲染流程的-css-优化建议)不做无用功：基于渲染流程的 CSS 优化建议
...
### [#](https://interview2.poetries.top/docs/performance.html#告别阻塞-css-与-js-的加载顺序优化)告别阻塞：CSS 与 JS 的加载顺序优化
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/36.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#小结-4)小结
...
## [#](https://interview2.poetries.top/docs/performance.html#九、渲染篇-3-对症下药-dom-优化原理与基本实践)九、渲染篇 3：对症下药——DOM 优化原理与基本实践
...
### [#](https://interview2.poetries.top/docs/performance.html#望闻问切-dom-为什么这么慢)望闻问切：DOM 为什么这么慢
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/37.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/38.png)
...
## [#](https://interview2.poetries.top/docs/performance.html#药到病除-给你的-dom-提提速)药到病除：给你的 DOM “提提速”
...
## [#](https://interview2.poetries.top/docs/performance.html#十、渲染篇-4-千方百计-event-loop-与异步更新策略)十、渲染篇 4：千方百计——Event Loop 与异步更新策略
...
### [#](https://interview2.poetries.top/docs/performance.html#前置知识-event-loop-中的-渲染时机)前置知识：Event Loop 中的“渲染时机”

搞懂 `Event Loop`，是理解 `Vue` 对 `DOM` 操作优化的第一步。

### [#](https://interview2.poetries.top/docs/performance.html#micro-task-与-macro-task)Micro-Task 与 Macro-Task

- 事件循环中的异步队列有两种：`macro`（宏任务）队列和 `micro`（微任务）队列。
- 常见的 `macro-task` 比如： `setTimeout`、`setInterval`、 `setImmediate`、`script`（整体代码）、 `I/O` 操作、`UI` 渲染等。
- 常见的 `micro-task` 比如: `process.nextTick`、`Promise`、`MutationObserver` 等。

### [#](https://interview2.poetries.top/docs/performance.html#event-loop-过程解析)Event Loop 过程解析
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/39.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/40.png)

### [#](https://interview2.poetries.top/docs/performance.html#渲染的时机)渲染的时机
...
### [#](https://interview2.poetries.top/docs/performance.html#生产实践-异步更新策略-以-vue-为例)生产实践：异步更新策略——以 Vue 为例
...
- 本小节我们从性能优化的角度出发，通过解析 Vue 源码，对异步更新这一高效的 `DOM` 优化手段有了感性的认知。同时帮助大家进一步熟悉了 `micro` 与 `macro` 在生产中的应用，加深了对 `Event Loop` 的理解。事实上，Vue 源码中还有许多值得称道的生产实践，其设计模式与编码细节都值得我们去细细品味。对这个话题感兴趣的同学，课后不妨移步 [Vue 运行机制解析 (opens new window)](https://juejin.im/book/5a36661851882538e2259c0f)进行探索。

### [#](https://interview2.poetries.top/docs/performance.html#小结-5)小结
...
## [#](https://interview2.poetries.top/docs/performance.html#十一、渲染篇-5-最后一击-回流-reflow-与重绘-repaint)十一、渲染篇 5：最后一击——回流（Reflow）与重绘（Repaint）
...
### [#](https://interview2.poetries.top/docs/performance.html#哪些实际操作会导致回流与重绘)哪些实际操作会导致回流与重绘
...
### [#](https://interview2.poetries.top/docs/performance.html#如何规避回流与重绘)如何规避回流与重绘
...
### [#](https://interview2.poetries.top/docs/performance.html#flush-队列-浏览器并没有那么简单)Flush 队列：浏览器并没有那么简单
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/41.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#小结-6)小结
...
## [#](https://interview2.poetries.top/docs/performance.html#十二、应用篇-1-优化首屏体验-lazy-load-初探)十二、应用篇 1：优化首屏体验——Lazy-Load 初探
...
### [#](https://interview2.poetries.top/docs/performance.html#lazy-load-初相见)Lazy-Load 初相见
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/42.png)

大家留意一栏文章右侧可能会出现的图片，这里咱们给个特写：

![img](https://img.poetries.top/static/gitee/2020/07/performance/43.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/44.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/45.png)

- 我们看到，这个还没来得及被图片填充完全的网页，是用大大小小的空 `div` 元素来占位的。掘金首页也是如此。
- 一旦我们通过滚动使得这个 `div` 出现在了可见范围内，那么 `div` 元素的内容就会发生变化，呈现如下的内容：

![img](https://img.poetries.top/static/gitee/2020/07/performance/46.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#一起写一个-lazy-load-吧)一起写一个 Lazy-Load 吧！
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/47.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/48.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#小结-7)小结
...
## [#](https://interview2.poetries.top/docs/performance.html#十三、应用篇-2-事件的节流-throttle-与防抖-debounce)十三、应用篇 2：事件的节流（throttle）与防抖（debounce）
...
### [#](https://interview2.poetries.top/docs/performance.html#节流-与-防抖-的本质)“节流”与“防抖”的本质

这两个东西都以**闭包**的形式存在。

它们通过对事件对应的回调函数进行包裹、以自由变量的形式缓存时间信息，最后用 setTimeout 来控制事件的触发频率。

### [#](https://interview2.poetries.top/docs/performance.html#throttle-第一个人说了算)Throttle： 第一个人说了算
...
### [#](https://interview2.poetries.top/docs/performance.html#debounce-最后一个人说了算)Debounce： 最后一个人说了算
...
### [#](https://interview2.poetries.top/docs/performance.html#用-throttle-来优化-debounce)用 Throttle 来优化 Debounce
...
### [#](https://interview2.poetries.top/docs/performance.html#小结-8)小结

> `throttle` 和 `debounce` 不仅是我们日常开发中的常用优质代码片段，更是前端面试中不可不知的高频考点。“看懂了代码”、“理解了过程”在本节都是不够的，重要的是把它写到自己的项目里去，亲自体验一把节流和防抖带来的性能提升。

## [#](https://interview2.poetries.top/docs/performance.html#十四、性能监测篇-performance、lighthouse-与性能-api)十四、性能监测篇：Performance、LightHouse 与性能 API
...
### [#](https://interview2.poetries.top/docs/performance.html#可视化监测-从-performance-面板说起)可视化监测：从 Performance 面板说起
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/49.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/50.png) ![img](https://img.poetries.top/static/gitee/2020/07/performance/51.png)

**2. 简要分析**

这里我打开掘金首页，选中 `Performance` 面板中的圆箭头，来看一下页面加载过程中的性能表现：

![img](https://img.poetries.top/static/gitee/2020/07/performance/52.png)

从上到下，依次为概述面板、详情面板。下我们先来观察一下概述面板，了解页面的基本表现：

![img](https://img.poetries.top/static/gitee/2020/07/performance/53.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/55.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#可视化监测-更加聪明的-lighthouse)可视化监测： 更加聪明的 LightHouse
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/56.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/57.png)

然后点击“Generate report”按钮，只需静候数秒，`LightHouse` 就会为我们输出一个完美的性能报告。

这里我拿掘金首页“开刀”：

![img](https://img.poetries.top/static/gitee/2020/07/performance/58.png)

稍事片刻，`Report` 便输出成功了，`LightHouse` 默认会帮我们打开一个新的标签页来展示报告内容。报告内容非常丰富，首先我们看到的是整体的跑分情况：

![img](https://img.poetries.top/static/gitee/2020/07/performance/59.png)

上述分别是页面性能、`PWA`（渐进式 Web 应用）、可访问性（无障碍）、最佳实践、`SEO` 五项指标的跑分。孰强孰弱，我们一看便知。

向下拉动 `Report` 页，我们还可以看到每一个指标的细化评估：

![img](https://img.poetries.top/static/gitee/2020/07/performance/60.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/61.png)

> `LightHouse` 因此变得更加触手可及了，这一操作也足以证明 `Chrome` 团队对 `LightHouse` 的推崇。

### [#](https://interview2.poetries.top/docs/performance.html#可编程的性能上报方案-w3c-性能-api)可编程的性能上报方案： W3C 性能 API
...
![img](https://img.poetries.top/static/gitee/2020/07/performance/62.png)

**2. 关键时间节点**

在 `performance` 的 `timing` 属性中，我们可以查看到如下的时间戳：

![img](https://img.poetries.top/static/gitee/2020/07/performance/63.png)

这些时间戳与页面整个加载流程中的关键时间节点有着一一对应的关系：

![img](https://img.poetries.top/static/gitee/2020/07/performance/64.png)
...
### [#](https://interview2.poetries.top/docs/performance.html#小结-9)小结
