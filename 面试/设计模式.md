...
![img](https://cos.poetries.work/gitee/2020/07/79.png)
...
![img](https://cos.poetries.work/gitee/2020/07/80.png)
...
![img](https://cos.poetries.work/gitee/2020/07/81.png)
...
![img](https://cos.poetries.work/gitee/2020/07/82.png)
...
![img](https://cos.poetries.work/gitee/2020/07/83.png)
...
![img](https://cos.poetries.work/gitee/2020/07/84.png)
...
![img](https://cos.poetries.work/gitee/2020/07/85.png)
...
![img](https://cos.poetries.work/gitee/2020/07/86.png)
...
![img](https://cos.poetries.work/gitee/2020/07/88.png)
...
![img](https://cos.poetries.work/gitee/2020/07/90.png)
...
![img](https://cos.poetries.work/gitee/2020/07/91.png)
...
![img](https://cos.poetries.work/gitee/2020/07/92.gif)
...
![img](https://cos.poetries.work/gitee/2020/07/93.png)
...
![img](https://cos.poetries.work/gitee/2020/07/94.png)
...
![img](https://cos.poetries.work/gitee/2020/07/95.png)
...
![img](https://cos.poetries.work/gitee/2020/07/96.png)
...
![img](https://cos.poetries.work/gitee/2020/07/97.png)
...
![img](https://cos.poetries.work/gitee/2020/07/98.png)
...
![img](https://cos.poetries.work/gitee/2020/07/99.png)
...
![img](https://cos.poetries.work/gitee/2020/07/100.png)
...
![img](https://cos.poetries.work/gitee/2020/07/101.png)
...
![img](https://cos.poetries.work/gitee/2020/07/102.png)
...
![img](https://cos.poetries.work/gitee/2020/07/103.png)
...
![img](https://cos.poetries.work/gitee/2020/07/104.png)
...
![img](https://cos.poetries.work/gitee/2020/07/105.png)
...
![img](https://cos.poetries.work/gitee/2020/07/106.png)
...
![img](https://cos.poetries.work/gitee/2020/07/107.png)
...
![img](https://cos.poetries.work/gitee/2020/07/108.png)
...
![img](https://cos.poetries.work/gitee/2020/07/109.png)
...
![img](https://cos.poetries.work/gitee/2020/07/112.png)
...
![img](https://cos.poetries.work/gitee/2020/07/113.png) ![img](https://cos.poetries.work/gitee/2020/07/114.png)
...
![img](https://cos.poetries.work/gitee/2020/07/115.png)

> 在实际操作时，用户可以直接对 `View` 层的 `UI` 进行操作，以通过事件通知 `Controller` 层，经过处理后修改 `Model` 层的数据，`Model` 层使用最新数据更新 `View`。示意图如下：

![img](https://cos.poetries.work/gitee/2020/07/116.png)

用户也可以直接触发 `Controller` 去更新 `Model` 层状态，再更新 View 层：

![img](https://cos.poetries.work/gitee/2020/07/117.png)
...
![img](https://cos.poetries.work/gitee/2020/07/120.png)
...
![img](https://cos.poetries.work/gitee/2020/07/121.png)

> 这是为什么呢，因为 `MVVM` 模式要求 `Model` 层和 `View` 层完全解耦，但是由于 `Vue` 还提供了 `ref` 这样的 `API`，使得 `Model` 也可以直接持有 `View`：

![img](https://cos.poetries.work/gitee/2020/07/122.png)
...
![img](https://cos.poetries.work/gitee/2020/07/125.png)
...
![img](https://cos.poetries.work/gitee/2020/07/126.png)
...
![img](https://cos.poetries.work/gitee/2020/07/127.png)
