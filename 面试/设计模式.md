## [#](https://interview2.poetries.top/docs/design-pattern.html#一、基础篇)一、基础篇
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#es6)ES6
...
![img](https://img.poetries.top/static/gitee/2020/07/79.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/80.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/84.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#建造者模式)建造者模式
...
![img](https://img.poetries.top/static/gitee/2020/07/85.png)
...
## [#](https://interview2.poetries.top/docs/design-pattern.html#三、结构型模式)三、结构型模式

### [#](https://interview2.poetries.top/docs/design-pattern.html#代理模式)代理模式
...
![img](https://img.poetries.top/static/gitee/2020/07/86.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/88.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/90.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#享元模式)享元模式
...
![img](https://img.poetries.top/static/gitee/2020/07/91.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/92.gif)
...
![img](https://img.poetries.top/static/gitee/2020/07/93.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/94.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#适配器模式)适配器模式
...
![img](https://img.poetries.top/static/gitee/2020/07/95.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#装饰者模式)装饰者模式
...
![img](https://img.poetries.top/static/gitee/2020/07/96.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#外观模式)外观模式
...
![img](https://img.poetries.top/static/gitee/2020/07/97.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/98.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#组合模式)组合模式
...
![img](https://img.poetries.top/static/gitee/2020/07/99.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#桥接模式)桥接模式
...
![img](https://img.poetries.top/static/gitee/2020/07/100.png)
...
## [#](https://interview2.poetries.top/docs/design-pattern.html#四、行为型模式)四、行为型模式

### [#](https://interview2.poetries.top/docs/design-pattern.html#发布-订阅模式)发布-订阅模式
...
![img](https://img.poetries.top/static/gitee/2020/07/101.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/102.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/103.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/104.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#策略模式)策略模式
...
![img](https://img.poetries.top/static/gitee/2020/07/105.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/106.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/107.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#状态模式)状态模式
...
![img](https://img.poetries.top/static/gitee/2020/07/108.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#模板方法模式-咖啡厅制作咖啡)模板方法模式：咖啡厅制作咖啡
...
![img](https://img.poetries.top/static/gitee/2020/07/109.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#迭代器模式-银行的点钞机)迭代器模式：银行的点钞机
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#命令模式-江湖通缉令)命令模式：江湖通缉令
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#职责链模式-领导-我想请个假)职责链模式：领导，我想请个假
...
![img](https://img.poetries.top/static/gitee/2020/07/112.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#中介者模式-找媒人介绍对象)中介者模式：找媒人介绍对象
...
``js /_ 男方 _/ const ZhangXiaoShuai = { name: '张小帅', family: '张小帅家', info: { age: 25, height: 171, salary: 5000 }, target: { age: [23, 27] } }

/_ 男方家长 _/ const ZhangXiaoShuaiParent = { name: '张小帅家长', family: '张小帅家', info: null, target: { height: [160, 167] } }

/_ 女方 _/ const LiXiaoMei = { name: '李小美', family: '李小美家', info: { age: 23, height: 160 }, target: { age: [25, 27] } }

/_ 女方家长 _/ const LiXiaoMeiParent = { name: '李小美家长', family: '李小美家', info: null, target: { salary: [10000, 20000] } }

/_ 媒人 _/ const MatchMaker = { matchBook: {}, // 媒人的花名册
...
/_ 注册 _/ MatchMaker.registPersons(ZhangXiaoShuai, ZhangXiaoShuaiParent, LiXiaoMei, LiXiaoMeiParent)
...
![img](https://img.poetries.top/static/gitee/2020/07/113.png) ![img](https://img.poetries.top/static/gitee/2020/07/114.png)
...
## [#](https://interview2.poetries.top/docs/design-pattern.html#五、其他模式)五、其他模式

### [#](https://interview2.poetries.top/docs/design-pattern.html#mvc、mvp、mvvm)MVC、MVP、MVVM
...
![img](https://img.poetries.top/static/gitee/2020/07/115.png)

> 在实际操作时，用户可以直接对 `View` 层的 `UI` 进行操作，以通过事件通知 `Controller` 层，经过处理后修改 `Model` 层的数据，`Model` 层使用最新数据更新 `View`。示意图如下：

![img](https://img.poetries.top/static/gitee/2020/07/116.png)

用户也可以直接触发 `Controller` 去更新 `Model` 层状态，再更新 View 层：

![img](https://img.poetries.top/static/gitee/2020/07/117.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/118.png)

> 在实际操作时，用户可以直接对 `View` 层的 `UI` 进行操作，`View` 层通知 `Presenter` 层，`Presenter` 层操作 `Model` 层的数据，`Presenter` 层获取到数据之后更新 `View`。示意图如下：

![img](https://img.poetries.top/static/gitee/2020/07/119.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/120.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/121.png)

> 这是为什么呢，因为 `MVVM` 模式要求 `Model` 层和 `View` 层完全解耦，但是由于 `Vue` 还提供了 `ref` 这样的 `API`，使得 `Model` 也可以直接持有 `View`：

![img](https://img.poetries.top/static/gitee/2020/07/122.png)

但是大多数帖子都说直接称呼 `Vue` 为 `MVVM` 框架，可见这些模式的划分也不是那么严格。

### [#](https://interview2.poetries.top/docs/design-pattern.html#模块模式)模块模式
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#链模式)链模式
...
![img](https://img.poetries.top/static/gitee/2020/07/125.png)
...
### [#](https://interview2.poetries.top/docs/design-pattern.html#中间件)中间件
...
![img](https://img.poetries.top/static/gitee/2020/07/126.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/127.png)
