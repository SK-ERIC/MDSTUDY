## [#](https://interview2.poetries.top/docs/simply.html#一、js基础)一、JS 基础
...
![img](https://img.poetries.top/static/gitee/2020/07/1.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_14-iterator迭代器)14 Iterator 迭代器
...
> 对象没有布局 Iterator 接口，无法使用`for of` 遍历。下面使得对象具备 Iterator 接口
...
![img](https://img.poetries.top/static/images/20210407141323.png)

### [#](https://interview2.poetries.top/docs/simply.html#_15-promise)15 Promise
...
![img](https://img.poetries.top/static/images/20210414175500.png)
...
![img](https://img.poetries.top/static/images/20210414210720.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_16-generator)16 Generator
...
![img](https://img.poetries.top/static/images/20210408100806.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_17-async-await)17 async/await
...
![img](https://img.poetries.top/static/images/20210414210917.png)

### [#](https://interview2.poetries.top/docs/simply.html#_18-事件循环)18 事件循环

![img](https://img.poetries.top/static/images/20210516161332.png)
...
![img](https://img.poetries.top/static/images/20210516162034.png) ![img](https://img.poetries.top/static/images/20210516162330.png)

> 自动执行的情况 会输出 listener1 listener2 task1 task2

![img](https://img.poetries.top/static/images/20210516162704.png) ![img](https://img.poetries.top/static/images/20210516163038.png)

> 如果手动点击 click 会一个宏任务取出来一个个执行，先执行 click 的宏任务，取出微任务去执行。会输出 listener1 task1 listener2 task2

![img](https://img.poetries.top/static/images/20210516163647.png)
...
![img](https://img.poetries.top/static/gitee/2020/09/10.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/fe/4.png)
...
- ```
  ...
  - ![img](https://img.poetries.top/static/images/20210516165328.png)
...
![img](https://img.poetries.top/static/images/20210414213126.png)
...
![img](https://img.poetries.top/static/images/20210414211816.png)
...
![img](https://img.poetries.top/static/images/20210414211850.png) ![img](https://img.poetries.top/static/images/20210516214402.png) ![img](https://img.poetries.top/static/images/20210516221825.png)
...
![img](https://img.poetries.top/static/images/20210414212124.png)
...
![img](https://img.poetries.top/static/images/20210424174311.png)
...
![img](https://img.poetries.top/static/images/20210516224232.png)
...
![img](https://img.poetries.top/static/images/20210414213602.png)
...
![img](https://img.poetries.top/static/images/20210529172258.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/fe/5.png)
...
![img](https://img.poetries.top/static/images/20210414212916.png)

### [#](https://interview2.poetries.top/docs/simply.html#_19-垃圾回收)19 垃圾回收
...
### [#](https://interview2.poetries.top/docs/simply.html#_20-内存泄露)20 内存泄露
...
### [#](https://interview2.poetries.top/docs/simply.html#_21-深浅拷贝)21 深浅拷贝

![img](https://img.poetries.top/static/images/20210414142630.png)
...
![img](https://img.poetries.top/static/images/20210414134752.png)
...
![img](https://img.poetries.top/static/images/20210414141731.png)
...
![img](https://img.poetries.top/static/images/20210414142525.png)

### [#](https://interview2.poetries.top/docs/simply.html#_22-节流与防抖)22 节流与防抖
...
### [#](https://interview2.poetries.top/docs/simply.html#_23-proxy代理)23 Proxy 代理
...
- 但是 proxy 不能用`Object.defineProperty`模拟
...
### [#](https://interview2.poetries.top/docs/simply.html#_24-ajax)24 Ajax

> 它是一种异步通信的方法，通过直接由 js 脚本向服务器发起 http 通信，然后根据服务器返回的数据，更新网页的相应部分，而不用刷新整个页面的一种方法。

![img](https://img.poetries.top/static/gitee/2020/09/9.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_25-深入数组)25 深入数组
...
![img](https://img.poetries.top/static/images/20210414163215.png)
...
![img](https://img.poetries.top/static/gitee/2020/09/7.png) ![img](https://img.poetries.top/static/gitee/2020/09/8.png)
...
![img](https://img.poetries.top/static/images/20210414164546.png)
...
![img](https://img.poetries.top/static/images/20210414164425.png)
...
![img](https://img.poetries.top/static/images/20210414164820.png)
...
![img](https://img.poetries.top/static/images/20210414164939.png)
...
![img](https://img.poetries.top/static/images/20210414165705.png)
...
![img](https://img.poetries.top/static/images/20210414170410.png)
...
![img](https://img.poetries.top/static/images/20210414170438.png)
...
![img](https://img.poetries.top/static/images/20210414170747.png)
...
![img](https://img.poetries.top/static/images/20210414171508.png)

其中你可以看到排序相关的时间复杂度和空间复杂度以及稳定性的情况，如果遇到需要自己实现排序的时候，可以根据它们的空间和时间复杂度综合考量，选择最适合的排序方法

## [#](https://interview2.poetries.top/docs/simply.html#二、html)二、HTML

### [#](https://interview2.poetries.top/docs/simply.html#_1-meta-标签-自动刷新-跳转)1 meta 标签：自动刷新/跳转
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-viewport)2 viewport
...
### [#](https://interview2.poetries.top/docs/simply.html#_3-性能优化)3 性能优化
...
![img](https://img.poetries.top/static/images/20210421163450.png)
...
- `dns-prefetch`。当 `link` 标签的 `rel` 属性值为“dns-prefetch”时，`浏览器会对某个域名预先进行 DNS 解析并缓存`。这样，当浏览器在请求同域名资源的时候，能省去从域名查询 IP 的过程，从而`减少时间损耗`。下图是淘宝网设置的 DNS 预解析 ![img](https://img.poetries.top/static/images/20210421163848.png)
...
![img](https://img.poetries.top/static/images/20210421164758.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_4-如何高效操作dom)4 如何高效操作 DOM
...
## [#](https://interview2.poetries.top/docs/simply.html#三、css基础)三、CSS 基础

### [#](https://interview2.poetries.top/docs/simply.html#_1-盒模型)1 盒模型
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-bfc)2 BFC
...
### [#](https://interview2.poetries.top/docs/simply.html#_3-层叠上下文)3 层叠上下文
...
![img](https://img.poetries.top/static/gitee/2020/09/111.png)

### [#](https://interview2.poetries.top/docs/simply.html#_4-左右居中方案)4 左右居中方案
...
### [#](https://interview2.poetries.top/docs/simply.html#_5-上下垂直居中方案)5 上下垂直居中方案
...
### [#](https://interview2.poetries.top/docs/simply.html#_6-选择器权重计算方式)6 选择器权重计算方式
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-清除浮动)7 清除浮动
...
.clearfix{ zoom: 1; /*IE6*/ } .clearfix:after{ content: "."; height: 0; clear:
both; display: block; visibility: hidden; }
```

> 推荐使用第三种方法，不会在页面新增 div，文档结构更加清晰

### [#](https://interview2.poetries.top/docs/simply.html#_8-左边定宽-右边自适应方案)8 左边定宽，右边自适应方案
...
### [#](https://interview2.poetries.top/docs/simply.html#_9-左右两边定宽-中间自适应)9 左右两边定宽，中间自适应
...
### [#](https://interview2.poetries.top/docs/simply.html#_10-css动画和过渡)10 CSS 动画和过渡
...
### [#](https://interview2.poetries.top/docs/simply.html#_11-css3的新特性)11 CSS3 的新特性
...
### [#](https://interview2.poetries.top/docs/simply.html#_12-列举几个css中可继承和不可继承的元素)12 列举几个 css 中可继承和不可继承的元素
...
## [#](https://interview2.poetries.top/docs/simply.html#四、浏览器)四、浏览器

![img](https://img.poetries.top/static/images/20210415090353.png)

### [#](https://interview2.poetries.top/docs/simply.html#_1-浏览器架构)1 浏览器架构

**单进程浏览器时代**

> 单进程浏览器是指浏览器的所有功能模块都是运行在同一个进程里，这些模块包含了网络、插件、JavaScript 运行环境、渲染引擎和页面等。其实早在 2007 年之前，市面上浏览器都是单进程的

![img](https://img.poetries.top/static/images/20210415092040.png)
...
![img](https://img.poetries.top/static/images/20210415092356.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-javascript单线程模型)2 JavaScript 单线程模型
...
### [#](https://interview2.poetries.top/docs/simply.html#_4-渲染机制)4 渲染机制
...
![img](https://img.poetries.top/static/gitee/2019/10/19.png)

![img](https://img.poetries.top/static/gitee/2019/10/20.png)
...
![img](https://img.poetries.top/static/gitee/2019/10/21.png)
...
![img](https://img.poetries.top/static/gitee/2019/10/22.png)

![img](https://img.poetries.top/static/gitee/2019/10/23.png)

### [#](https://interview2.poetries.top/docs/simply.html#_5-缓存机制)5 缓存机制
...
### [#](https://interview2.poetries.top/docs/simply.html#_6-浏览器存储)6 浏览器存储
...
![img](https://img.poetries.top/static/images/20210421172522.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-跨域方案)7 跨域方案
...
### [#](https://interview2.poetries.top/docs/simply.html#_8-xss-和-csrf)8 XSS 和 CSRF

![img](https://img.poetries.top/static/images/20210415090547.png)
...
![image.png](https://img.poetries.top/static/gitee/2020/07/4.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/fe/19.png)
...
![img](https://img.poetries.top/static/gitee/2020/07/fe/20.png)
...
![img](https://img.poetries.top/static/images/20210506174602.png)

```js
res.setHeader(
  "Set-Cookie",
  `username=poetry2;sameSite = strict;path=/;httpOnly;expires=${getCookirExpires()}`
);
```
...
![img](https://img.poetries.top/static/images/20210506174856.png)
...
res.setHeader(
  "Set-Cookie",
  `username=poetry;sameSite=strict;path=/;httpOnly;expires=${getCookirExpires()}`
);
```

![img](https://img.poetries.top/static/images/20210506175834.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_9-service-worker)9 Service Worker
...
![img](https://img.poetries.top/static/gitee/2020/09/96.png)

> 在 Cache 中也可以发现我们所需的文件已被缓存

![img](https://img.poetries.top/static/gitee/2020/09/97.png)

> 当我们重新刷新页面可以发现我们缓存的数据是从 `Service` `Worker` 中读取的

### [#](https://interview2.poetries.top/docs/simply.html#_10-dom-节点操作)10 DOM 节点操作
...
### [#](https://interview2.poetries.top/docs/simply.html#_11-掌握页面的加载过程)11 掌握页面的加载过程
...
![img](https://img.poetries.top/static/images/20210420215756.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_12-从输入url到页面展示过程)12 从输入 URL 到页面展示过程

![img](https://img.poetries.top/static/images/20210504134355.png)

**1. DNS 域名解析**

![img](https://img.poetries.top/static/images/20210504134816.png)
...
![img](https://img.poetries.top/static/images/20210504134850.png)
...
![img](https://img.poetries.top/static/images/20210504134913.png)

结合起来的过程，可以用一个图表示：

![img](https://img.poetries.top/static/images/20210504134925.png)
...
![img](https://img.poetries.top/static/images/20210504135417.png)
...
![img](https://img.poetries.top/static/images/20210504135549.png)
...
![img](https://img.poetries.top/static/images/20210504135701.png)
...
![img](https://img.poetries.top/static/images/20210504135900.png)
...
![img](https://img.poetries.top/static/images/20210504140042.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_13-渲染引擎什么情况下才会为特定的节点创建新的图层)13 渲染引擎什么情况下才会为特定的节点创建新的图层
...
这里的剪裁指的是，假如我们把 div 的大小限定为 200 _ 200 像素，而 div 里面的文字内容比较多，文字所显示的区域肯定会超出 200 _ 200 的面积，这时候就产生了剪裁，渲染引擎会把裁剪文字内容的一部分用于显示在 div 区域。出现这种裁剪情况的时候，渲染引擎会为文字部分单独创建一个层，如果出现滚动条，滚动条也会被提升为单独的层。

### [#](https://interview2.poetries.top/docs/simply.html#_14-定时器与requestanimationframe、requestidlecallback)14 定时器与 requestAnimationFrame、requestIdleCallback
...
![img](https://img.poetries.top/static/images/20210504201448.png)
...
![img](https://img.poetries.top/static/images/20210504201623.png)
...
![img](https://img.poetries.top/static/images/20210504202154.png)
...
## [#](https://interview2.poetries.top/docs/simply.html#五、框架通识)五、框架通识

[框架通识(opens new window)](http://interview.poetries.top/excellent-docs/16-框架通识.html)

## [#](https://interview2.poetries.top/docs/simply.html#六、vue)六、Vue

### [#](https://interview2.poetries.top/docs/simply.html#_1-vue-响应式原理)1 Vue 响应式原理
...
![img](https://img.poetries.top/static/gitee/2021/01/15.png)
...
![img](https://img.poetries.top/static/gitee/2021/01/16.png)
...
![img](https://img.poetries.top/static/gitee/20190922/vue.jpeg)
...
![img](https://img.poetries.top/static/images/20210408091523.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-发布订阅模式和观察者模式)2 发布订阅模式和观察者模式
...
![img](https://img.poetries.top/static/images/20210328214834.png)

### [#](https://interview2.poetries.top/docs/simply.html#_3-为什么使用-virtual-dom)3 为什么使用 Virtual DOM
...
![img](https://img.poetries.top/static/images/20210328112610.png)

### [#](https://interview2.poetries.top/docs/simply.html#_4-vdom-三个-part)4 VDOM：三个 part
...
### [#](https://interview2.poetries.top/docs/simply.html#_5-vue-和-react技术选型)5 vue 和 react 技术选型
...
### [#](https://interview2.poetries.top/docs/simply.html#_6-nexttick)6 nextTick
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-生命周期)7 生命周期

![img](https://img.poetries.top/static/images/20210408093135.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_8-vue-router)8 vue-router
...
### [#](https://interview2.poetries.top/docs/simply.html#_9-vuex)9 vuex
...
### [#](https://interview2.poetries.top/docs/simply.html#_10-vue3带来的新特性-亮点)10 vue3 带来的新特性/亮点
...
<template>
  <div>123</div>
  <Teleport to="#container"> Teleport </Teleport>
</template>
...
![img](https://img.poetries.top/static/images/20210407162653.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_11-compositon-api)11 Compositon api
...
### [#](https://interview2.poetries.top/docs/simply.html#_12-computed-的实现原理)12 computed 的实现原理
...
### [#](https://interview2.poetries.top/docs/simply.html#_13-watch-的理解)13 watch 的理解
...
### [#](https://interview2.poetries.top/docs/simply.html#_14-vue-渲染过程)14 vue 渲染过程

![img](https://img.poetries.top/static/images/20210504211204.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_15-说一说keep-alive实现原理)15 说一说 keep-alive 实现原理
...
### [#](https://interview2.poetries.top/docs/simply.html#_16-为什么访问data属性不需要带data)16 为什么访问 data 属性不需要带 data
...
### [#](https://interview2.poetries.top/docs/simply.html#_17-template预编译是什么)17 template 预编译是什么
...
### [#](https://interview2.poetries.top/docs/simply.html#_18-介绍一下vue中的diff算法)18 介绍一下 Vue 中的 Diff 算法
...
### [#](https://interview2.poetries.top/docs/simply.html#_19-说说vue2-0和vue3-0有什么区别)19 说说 Vue2.0 和 Vue3.0 有什么区别
...
## [#](https://interview2.poetries.top/docs/simply.html#七、react)七、React

### [#](https://interview2.poetries.top/docs/simply.html#_0-对虚拟dom的理解)0 对虚拟 DOM 的理解
...
[真正理解虚拟 DOM(opens new window)](http://interview.poetries.top/principle-docs/react/15-真正理解虚拟DOM.html)

### [#](https://interview2.poetries.top/docs/simply.html#_1-谈谈你对react的理解)1 谈谈你对 React 的理解
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-如何避免react生命周期中的坑)2 如何避免 React 生命周期中的坑

**16.3 版本**

![img](https://img.poetries.top/static/images/20210409153251.png)

**>=16.4 版本**

![img](https://img.poetries.top/static/images/20210409153312.png)
...
![img](https://img.poetries.top/static/images/20210425121355.png)
...
![img](https://img.poetries.top/static/images/20210426200953.png)
...
![img](https://img.poetries.top/static/images/20210426201045.png)
...
![img](https://img.poetries.top/static/images/20210426201155.png)
...
> - [React16 为什么要更改生命周期(opens new window)](<http://interview.poetries.top/principle-docs/react/12-React16为什么要更改生命周期(上).html>)
> - [React16 为什么要更改生命周期(opens new window)](<http://interview.poetries.top/principle-docs/react/12-React16为什么要更改生命周期(下).html>)

### [#](https://interview2.poetries.top/docs/simply.html#_3-react-fiber架构)3 React Fiber 架构
...
![img](https://img.poetries.top/static/images/20210407173320.png)
...
![img](https://img.poetries.top/static/images/20210407174007.png)
...
![img](https://img.poetries.top/static/images/20210407173933.png)
...
![img](https://img.poetries.top/static/images/20210407173949.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_4-createelement过程)4 createElement 过程
...
### [#](https://interview2.poetries.top/docs/simply.html#_5-调和阶段-setstate内部干了什么)5 调和阶段 setState 内部干了什么
...
### [#](https://interview2.poetries.top/docs/simply.html#_6-setstate)6 setState
...
![img](https://img.poetries.top/static/images/20210425140749.png)
...
![img](https://img.poetries.top/static/images/20210409153900.png) ![img](https://img.poetries.top/static/images/20210409153914.png) ![img](https://img.poetries.top/static/images/20210409153926.png) ![img](https://img.poetries.top/static/images/20210409153942.png) ![img](https://img.poetries.top/static/images/20210409154004.png) ![img](https://img.poetries.top/static/images/20210409154015.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-setstate原理分析)7 setState 原理分析
...
![img](https://img.poetries.top/static/gitee/2019/10/431.png)

> 因为`setState`是可以接受两个参数的，一个`state`，一个回调函数。因此我们可以在回调函数里面获取值

![img](https://img.poetries.top/static/gitee/2019/10/432.png)
...
![img](https://img.poetries.top/static/gitee/2019/10/434.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_8-react事务机制)8 React 事务机制

![img](https://img.poetries.top/static/images/20210409154118.png) ![img](https://img.poetries.top/static/images/20210409154127.png) ![img](https://img.poetries.top/static/images/20210409154136.png)

### [#](https://interview2.poetries.top/docs/simply.html#_9-react组件和渲染更新过程)9 React 组件和渲染更新过程
...
### [#](https://interview2.poetries.top/docs/simply.html#_10-如何解释-react-的渲染流程)10 如何解释 React 的渲染流程

![img](https://img.poetries.top/static/images/20210425210718.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_11-diff算法是怎么运作)11 diff 算法是怎么运作
...
![img](https://img.poetries.top/static/images/20210307225249.png)
...
![image-20210307224725566](https://img.poetries.top/static/images/image-20210307224725566.png)

那么问题来了，如果 DOM 节点出现了跨层级操作,diff 会咋办呢？

> 答：diff 只简单考虑同层级的节点位置变换，如果是跨层级的话，只有创建节点和删除节点的操作。

![image-20210307224829092](https://img.poetries.top/static/images/image-20210307224829092.png)
...
![image-20210302195610674](https://img.poetries.top/static/images/image-20210302195610674.png)

这就意味着，如果 dom 节点发生了跨层级移动，react 会删除旧的节点，生成新的节点，而不会复用。

1. `component diff`：如果不是同一类型的组件，会删除旧的组件，创建新的组件

![image-20210302195654736](https://img.poetries.top/static/images/image-20210302195654736.png)
...
![img](https://img.poetries.top/static/images/20210425203918.png)

> diff 算法探讨的就是虚拟 DOM 树发生变化后，生成 DOM 树更新补丁的方式。它通过对比新旧两株虚拟 DOM 树的变更差异，将更新补丁作用于真实 DOM，以最小成本完成视图更新

![img](https://img.poetries.top/static/images/20210425204127.png)
...
![img](https://img.poetries.top/static/images/20210425204151.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_12-合成事件原理)12 合成事件原理
...
![img](https://img.poetries.top/static/images/20210425135711.png)
...
![img](https://img.poetries.top/static/images/20210425135751.png)
...
![img](https://img.poetries.top/static/images/20210409153648.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_13-jsx语法糖本质)13 JSX 语法糖本质
...
![img](https://img.poetries.top/static/images/20210407215708.png) ![img](https://img.poetries.top/static/images/20210407215721.png)
...
![img](https://img.poetries.top/static/images/20210407215754.png)
...
![img](https://img.poetries.top/static/images/20210407220013.png)

> react 通过 babel 把 JSX 转成`createElement`函数，生成`ReactElement`对象，然后通过`ReactDOM.render函`数把`ReactElement`渲染成真实的`DOM`元素

**为什么 React 使用 JSX**

![img](https://img.poetries.top/static/images/20210425120721.png)
...
![img](https://img.poetries.top/static/images/20210426192237.png)

> createElement 中并没有十分复杂的涉及算法或真实 DOM 的逻辑，它的每一个步骤几乎都是在格式化数据。

![img](https://img.poetries.top/static/images/20210426192648.png)
...
![img](https://img.poetries.top/static/images/20210426193812.png)
...
![img](https://img.poetries.top/static/images/20210426193901.png)

这个 `ReactElement` 对象实例，本质上是以 JavaScript 对象形式存在的对 `DOM` 的描述，也就是老生常谈的“虚拟 DOM”（准确地说，是虚拟 `DOM` 中的一个节点)

### [#](https://interview2.poetries.top/docs/simply.html#_14-为什么-react-元素有一个-typeof-属性)14 为什么 React 元素有一个 $$typeof 属性

![image-20210302200213923](https://img.poetries.top/static/images/image-20210302200213923.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_15-virtual-dom-的工作原理是什么)15 Virtual DOM 的工作原理是什么

![img](https://img.poetries.top/static/images/20210425201821.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_16-react有哪些优化性能的手段)16 React 有哪些优化性能的手段
...
### [#](https://interview2.poetries.top/docs/simply.html#_17-redux实现原理解析)17 Redux 实现原理解析
...
![img](https://img.poetries.top/static/gitee/2020/07/68.png)
...
![img](https://img.poetries.top/static/images/20210426215948.png)
...
![img](https://img.poetries.top/static/images/20210427115241.png)
...
![img](https://img.poetries.top/static/images/20210427115322.png)

### [#](https://interview2.poetries.top/docs/simply.html#_18-谈谈你对状态管理的理解)18 谈谈你对状态管理的理解
...
![img](https://img.poetries.top/static/images/20210425201200.png)

### [#](https://interview2.poetries.top/docs/simply.html#_19-connect组件原理分析)19 connect 组件原理分析
...
### [#](https://interview2.poetries.top/docs/simply.html#_20-react-hooks)20 React Hooks
...
![img](https://img.poetries.top/static/images/20210425213051.png)
...
![img](https://img.poetries.top/static/images/20210425213302.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_21-受控组件和非受控组件)21 受控组件和非受控组件
...
### [#](https://interview2.poetries.top/docs/simply.html#_22-如何避免ajax数据请求重新获取)22 如何避免 ajax 数据请求重新获取

> 一般而言，ajax 请求的数据都放在 redux 中存取。

### [#](https://interview2.poetries.top/docs/simply.html#_23-组件之间通信)23 组件之间通信
...
![img](https://img.poetries.top/static/images/20210425145857.png)

### [#](https://interview2.poetries.top/docs/simply.html#_24-类组件与函数组件有什么区别呢)24 类组件与函数组件有什么区别呢？
...
![img](https://img.poetries.top/static/images/20210425134417.png)

### [#](https://interview2.poetries.top/docs/simply.html#_25-如何设计react组件)25 如何设计 React 组件
...
![img](https://img.poetries.top/static/images/20210425134939.png)

### [#](https://interview2.poetries.top/docs/simply.html#_26-组件的协同及-不-可控组件)26 组件的协同及（不）可控组件

**为什么要进行组件的协同**

- 我们在实际的开发项目的时候，不会只用几个组件，有时候遇到大型的项目，可能会有成千上百的组件，难免会遇到有功能重复的组件。要进行修改，就会修改大部分的文件。所以我们需要进行组件的协同开发。

![img](https://img.poetries.top/static/images/20210427114453.png)
...
![img](https://img.poetries.top/static/images/20210427114544.png)
...
![img](https://img.poetries.top/static/images/20210427114655.png)
...
![img](https://img.poetries.top/static/images/20210427114820.png)
...
![img](https://img.poetries.top/static/images/20210427114833.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_27-react-router-的实现原理及工作方式分别是什么)27 React-Router 的实现原理及工作方式分别是什么
...
![img](https://img.poetries.top/static/images/20210425214114.png)

![img](https://img.poetries.top/static/images/20210409164620.png)

[React router 原理分析(opens new window)](http://interview.poetries.top/principle-docs/react/01-React-router原理.html)

### [#](https://interview2.poetries.top/docs/simply.html#_28-react-17-带来了哪些改变)28 React 17 带来了哪些改变
...
## [#](https://interview2.poetries.top/docs/simply.html#八、性能)八、性能

### [#](https://interview2.poetries.top/docs/simply.html#_1-dns-预解析)1 DNS 预解析
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-缓存)2 缓存
...
### [#](https://interview2.poetries.top/docs/simply.html#_3-使用-http-2-0)3 使用 HTTP / 2.0

- 因为浏览器会有并发请求限制，在 `HTTP / 1.1` 时代，每个请求都需要建立和断开，消耗了好几个 `RTT` 时间，并且由于 `TCP` 慢启动的原因，加载体积大的文件会需要更多的时间
- 在 `HTTP / 2.0` 中引入了多路复用，能够让多个请求使用同一个 `TCP` 链接，极大的加快了网页的加载速度。并且还支持 `Header` 压缩，进一步的减少了请求的数据大小

### [#](https://interview2.poetries.top/docs/simply.html#_4-预加载)4 预加载
...
### [#](https://interview2.poetries.top/docs/simply.html#_5-预渲染)5 预渲染
...
### [#](https://interview2.poetries.top/docs/simply.html#_6-懒执行与懒加载)6 懒执行与懒加载
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-文件优化)7 文件优化
...
### [#](https://interview2.poetries.top/docs/simply.html#_8-其他)8 其他
...
### [#](https://interview2.poetries.top/docs/simply.html#_9-如何根据chrome的timing优化)9 如何根据 chrome 的 timing 优化
...
![image-20210307184052955](https://img.poetries.top/static/images/image-20210307184052955.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_10-移动端优化)10 移动端优化
...
## [#](https://interview2.poetries.top/docs/simply.html#九、工程化)九、工程化

### [#](https://interview2.poetries.top/docs/simply.html#_1-介绍一下-webpack-的构建流程)1 介绍一下 webpack 的构建流程
...
![img](https://img.poetries.top/static/images/20210422211832.png)
...
![img](https://img.poetries.top/static/images/20210517175408.png)
...
![img](https://img.poetries.top/static/images/20210503212144.png)

**webpack 详细工作流程**

![img](https://img.poetries.top/static/images/20210517174932.png)

### [#](https://interview2.poetries.top/docs/simply.html#_2-介绍-loader)2 介绍 Loader
...
### [#](https://interview2.poetries.top/docs/simply.html#_3-介绍-plugin)3 介绍 plugin
...
### [#](https://interview2.poetries.top/docs/simply.html#_4-webpack-热更新实现原理)4 webpack 热更新实现原理

![img](https://img.poetries.top/static/images/20210319101659.png)

**HMR 的基本流程图**

![img](https://img.poetries.top/static/images/20210422211446.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_5-webpack-层面如何做性能优化)5 webpack 层面如何做性能优化
...
![img](https://img.poetries.top/static/images/20210409165629.png) ![img](https://img.poetries.top/static/images/20210409165723.png)

### [#](https://interview2.poetries.top/docs/simply.html#_6-介绍一下-tree-shaking)6 介绍一下 Tree Shaking
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-介绍一下-webpack-scope-hosting)7 介绍一下 webpack scope hosting

> 作用域提升，将分散的模块划分到同一个作用域中，避免了代码的重复引入，有效减少打包后的代码体积和运行时的内存损耗；

### [#](https://interview2.poetries.top/docs/simply.html#_8-webpack-proxy工作原理-为什么能解决跨域)8 Webpack Proxy 工作原理？为什么能解决跨域
...
![img](https://img.poetries.top/static/images/20210507090546.png)

在代理服务器传递数据给本地浏览器的过程中，两者同源，并不存在跨域行为，这时候浏览器就能正常接收数据

> 注意：`「服务器与服务器之间请求数据并不会存在跨域行为，跨域行为是浏览器安全策略限制」`

### [#](https://interview2.poetries.top/docs/simply.html#_9-介绍一下-babel原理)9 介绍一下 babel 原理
...
[Babel 原理及其使用(opens new window)](http://interview.poetries.top/principle-docs/webpack/05-Babel原理及其使用.html)

### [#](https://interview2.poetries.top/docs/simply.html#_10-介绍一下rollup)10 介绍一下 Rollup
...
![img](https://img.poetries.top/static/images/20210704203811.png)

## [#](https://interview2.poetries.top/docs/simply.html#十、http)十、HTTP

### [#](https://interview2.poetries.top/docs/simply.html#http状态码)HTTP 状态码
...
### [#](https://interview2.poetries.top/docs/simply.html#_1-http前生今世)1 HTTP 前生今世

![img](https://img.poetries.top/static/images/20210421175226.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-http世界全览)2 HTTP 世界全览

![img](https://img.poetries.top/static/images/20210503202857.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_3-http分层)3 HTTP 分层

![img](https://img.poetries.top/static/images/20210503203408.png) ![img](https://img.poetries.top/static/images/20210507090818.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_4-http报文是什么样子的)4 HTTP 报文是什么样子的
...
![img](https://img.poetries.top/static/images/20210503203917.png)

![img](https://img.poetries.top/static/images/20210503203927.png)

### [#](https://interview2.poetries.top/docs/simply.html#_5-http之url)5 HTTP 之 URL

![img](https://img.poetries.top/static/images/20210503204105.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_6-http实体数据)6 HTTP 实体数据
...
![img](https://img.poetries.top/static/gitee/2019/12/15.png)
...
![img](https://img.poetries.top/static/gitee/2019/12/16.png)
...
![img](https://img.poetries.top/static/gitee/2019/12/17.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-谈一谈http协议优缺点)7 谈一谈 HTTP 协议优缺点
...
### [#](https://interview2.poetries.top/docs/simply.html#_8-说一说http-的请求方法)8 说一说 HTTP 的请求方法
...
### [#](https://interview2.poetries.top/docs/simply.html#_9-谈一谈get-和-post-的区别)9 谈一谈 GET 和 POST 的区别
...
### [#](https://interview2.poetries.top/docs/simply.html#_10-谈一谈队头阻塞问题)10 谈一谈队头阻塞问题
...
### [#](https://interview2.poetries.top/docs/simply.html#_11-谈一谈http数据传输)11 谈一谈 HTTP 数据传输
...
### [#](https://interview2.poetries.top/docs/simply.html#_12-cookie-和-session)12 cookie 和 session
...
### [#](https://interview2.poetries.top/docs/simply.html#_13-介绍一下https和http区别)13 介绍一下 HTTPS 和 HTTP 区别
...
![img](https://img.poetries.top/static/images/20210409105003.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_14-https握手过程)14 HTTPS 握手过程
...
### [#](https://interview2.poetries.top/docs/simply.html#_15-介绍一个https工作原理)15 介绍一个 HTTPS 工作原理
...
![img](https://img.poetries.top/static/images/20210409105413.png)
...
![img](https://img.poetries.top/static/images/20210409105827.png)
...
![img](https://img.poetries.top/static/images/20210409105910.png)
...
![img](https://img.poetries.top/static/images/20210409110016.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_16-ssl-连接断开后如何恢复)16 SSL 连接断开后如何恢复
...
### [#](https://interview2.poetries.top/docs/simply.html#_17-谈一谈你对http-2理解)17 谈一谈你对 HTTP/2 理解
...
### [#](https://interview2.poetries.top/docs/simply.html#_18-http3)18 HTTP3
...
### [#](https://interview2.poetries.top/docs/simply.html#_19-http-1-0-http1-1-http2-0版本之间的差异)19 HTTP/1.0 HTTP1.1 HTTP2.0 版本之间的差异
...
### [#](https://interview2.poetries.top/docs/simply.html#_20-dns如何工作的)20 DNS 如何工作的
...
![img](https://img.poetries.top/static/images/20210503210054.png)

**我们通过一张图来看看它的查询过程吧**👇

![img](https://img.poetries.top/static/images/20210409102754.png)

这张图很生动的展示了 DNS 在本地 DNS 服务器是如何查询的，**一般向本地 DNS 服务器发送请求是递归查询的**

本地 DNS 服务器向其他域名服务器请求的过程是迭代查询的过程 👇

![img](https://img.poetries.top/static/images/20210409102812.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_21-短轮询、长轮询和-websocket-间的区别)21 短轮询、长轮询和 WebSocket 间的区别
...
### [#](https://interview2.poetries.top/docs/simply.html#_22-说一说正向代理和反向代理)22 说一说正向代理和反向代理
...
### [#](https://interview2.poetries.top/docs/simply.html#_23-介绍一下connection-keep-alive)23 介绍一下 Connection:keep-alive
...
![img](https://img.poetries.top/static/images/20210409103238.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_24-http-https-协议总结)24 http/https 协议总结
...
### [#](https://interview2.poetries.top/docs/simply.html#_25-tcp为什么要三次握手)25 TCP 为什么要三次握手
...
![img](https://img.poetries.top/static/images/20210426214034.png)

> 你可以能会问，2 次握手就足够了？。但其实不是，因为服务端还没有确定客户端是否准备好了。比如步骤 3 之后，服务端马上给客户端发送数据，这个时候客户端可能还没有准备好接收数据。因此还需要增加一个过程

![img](https://img.poetries.top/static/images/20210421174925.png)
...
![img](https://img.poetries.top/static/images/20210426214118.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_26-为什么要有-websocket)26 为什么要有 WebSocket
...
![img](https://img.poetries.top/static/images/20210503205601.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#_27-udp和tcp有什么区别)27 UDP 和 TCP 有什么区别
...
![img](https://img.poetries.top/static/images/20210504140502.png)

## [#](https://interview2.poetries.top/docs/simply.html#十一、9种前端常见的设计模式)十一、9 种前端常见的设计模式

### [#](https://interview2.poetries.top/docs/simply.html#_1-外观模式)1. 外观模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_2-代理模式)2. 代理模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_3-工厂模式)3. 工厂模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_4-单例模式)4. 单例模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_5-策略模式)5. 策略模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_6-迭代器模式)6. 迭代器模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_7-观察者模式)7. 观察者模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_8-中介者模式)8. 中介者模式
...
### [#](https://interview2.poetries.top/docs/simply.html#_9-访问者模式)9. 访问者模式
...
## [#](https://interview2.poetries.top/docs/simply.html#十二、综合问题)十二、综合问题
...
### [#](https://interview2.poetries.top/docs/simply.html#把握投递简历的黄金时间段)把握投递简历的黄金时间段
...
![img](https://img.poetries.top/static/images/20210414092128.png)
...
![img](https://img.poetries.top/static/images/20210414092111.png)
...
### [#](https://interview2.poetries.top/docs/simply.html#把握面试时的关键点)把握面试时的关键点
...
### [#](https://interview2.poetries.top/docs/simply.html#工作交接流程-福利衔接)工作交接流程 & 福利衔接
...
## [#](https://interview2.poetries.top/docs/simply.html#十三、人事面)十三、人事面

### [#](https://interview2.poetries.top/docs/simply.html#第一个要点-你是否胜任这份工作)第一个要点: 你是否胜任这份工作？
...
- 短期项目和长期项目有很好的平衡。
- 热爱并有能力完成这份工作。
- 我将全身心的投入到工作中，能够很好的完成工作项目如：**\_**（可以根据招聘信息上对该岗位工作内容的描述填写）
...
- 能发挥我的特长：**\_**。
- 赋予我责任包括：**\_**（岗位责任）。
- 有吸引我的企业文化，如贵司的**\_**（可以适当夸赞下公司的企业文化、特色等）。
- 能更好的锻炼我的**\_**（能力）。
- 提供与人交流沟通并互相帮助的工作环境。
...
- 我经常志愿参加团体活动，一般都有**\_**到**\_**人参加，我在其中担任负责人。
- 我负责过**\_**人的项目，虽然并不是日常管理，但是作为项目经理，我主持的项目都会提前完成，并控制预算在**\_**元以内。

**5. 你承担过哪些经济责任？**

- 在上份工作中，我负责过预算为**\_**的项目。
- 经过前三份工作，我负责的项目预算越来越多，经济责任也越来越大，从第一份工作的**\_**到最近**\_**的项目。
- 我是从负责技术转为负责财务。随着公司的发展，我不仅负责部门的技术工作，还负责采购和执行方面的财务工作。
- 在我之前的工作中，我并未涉及过财务方面的事务，但我相信我全面了解自己的工作，能够处理好。
- 我虽然没有直接负责财务问题，但是我负责管理过一个**\_**的项目。
- 我负责过一个大型的项目，对公司尤为重要，能够带来**\_**的利润。虽然我没有直接负责财务，但我的领导对项目的成功起着举足轻重的作用。
- 我设法使销售额在 18 个月的时间里翻了三倍，从**\_**到**\_**。
...
- 是否暂缓部门扩大计划。
- 是否减少自己和手下员工的薪酬，以免裁员。
- 是否接受晋升继续在原公司工作还是回学校深造。我选择**\_**，因为**\_**。

**7. 带给你最大满足感的成就有哪些？**

- 描述一个让你感到骄傲又做的非常专业的事情，并解释下为什么这件事带给你满足感。
- 设法在降低 40%成本的基础上，将产能提高了一倍。
- 解决了同事无法解决的问题。
- 提前在预算内完成任务。
- 在面对巨大困难**\_**时，也能圆满达成目标**\_**。
- 可以描述一个与你现在正在面试的岗位要求类似，你又成功完成的项目。
- 在大学期间，获得**\_**，使我得到了**\_**的实习机会。
...
- 我在**\_**的丰富的经历，可以使我比那些慢慢成长起来的人更快的开展工作。
- 我过往的经历和能力都很适合这份工作，我有信心在岗位上有优秀的表现。
- 你是否对我简历上所写的能力有疑问，我很愿意为你解答。
- 如果是，我相信这部分资历也能为您和您的公司所用。
- 也许是这样，在我的职业生涯中有幸获得过很多好的工作机会，使我更注重工作给我的满足感，并更乐于**\_**（表述岗位职责）。
...
- 这是一份具有挑战性的工作。
- 这是一份需要注重客户满意度的工作。
- 这是我理想中的工作，为了这份工作，我做过各种调研，努力提高自我能力，比如：**\_**。
- 这份工作注重**\_**，需要很高的职业素养,如：**\_**，我很愿意提高自身水平达到贵司的要求。

**17. 你将如何职业性的提升自己？**

- 通过三种途径提升自己：阅读专业杂志、参加会议、研修继续教育课程。
- 紧跟行业潮流，学习技术，不断突破。
- 尝试新事物，学习新技能，开发新兴趣，比如：**\_**。
- 接受行业导师的指导，提高自身能力。
...
- 在我 23 岁时便升任经理，尽管有很多资历和年纪都比我老的员工，但我领导还是因为我的潜力冒着风险提拔了我，最终她没有后悔自己的决定。
...
### [#](https://interview2.poetries.top/docs/simply.html#第二个要点-你是怎样的人)第二个要点：你是怎样的人？
...
- 这是个很宽泛的要求，你可以适当的提问面试官，然后再介绍面试官关心的信息。例如：**\_**。
...
- 更好的了解**\_**的市场需求。
- 工作方面，想参加一个**\_**培训提高自己的技能。私人生活上，想练习下**\_**（这里可以提一些对社交有帮助的活动或是兴趣爱好）。
...
- 在我看来，创新便是能从不同的或者时全新的角度去思考并发现各种可能性的一种能力。我在上一份工作中，曾经：**\_**。
...
- 我认为成功是应该被量化的。比如，我决定让手下员工接受培训，尽管竞争激烈，但在半年间，减少了 9%的流转率。
- 我认为成功就是超既定的目标不断前进。
...
### [#](https://interview2.poetries.top/docs/simply.html#第三个要点-你是否适合这个企业)第三个要点：你是否适合这个企业？
...
- 有自信，有竞争力。
- 平易近人。
- 我从他身上学到了很多，比如：**\_**（如何与人相处，如何开展谈判，如何据理力争等）。
...
- 我和我的上司在**\_**意见无法达成一致。经过考虑，换一份工作更好。
...
- 在我过去的三份工作中，我都从与我领导的共事中学到了很多，比如：**\_**。
...
- 我向领导提出离职后被挽留，并且得到很多许诺，但是我还是决定重新找工作，因为：**\_**。
...
- 非常出色。这是领导跟我之间积极又建设性的交流。我明确达到了目标：**\_**。
- 总体不错。是一次对我来说非常有帮助的反馈。我意识到在**\_**我需要在未来的工作中加强训练。
- 不是很满意。我应该多跟领导沟通。对他的期许我还有很多沟通不到位的地方。
- 非常好。（提下自己优异的表现）

**80. 你为什么要找工作？**

- 我在上一家公司已经工作了 X 年，我相信我的工作技能和能力都在此期间得到了提高，但是没有进一步的发展空间。我想找一份与我能力更匹配的工作。
- 我希望我的职业生涯有所改变，能服务于更好的公司，比如：**\_**。
...
- 对已收到的 offer 进行研究，仔细考虑。只接受有意义、有质量的工作岗位。
...
- 我关注贵司很久，贵司最吸引我的地方是：**\_**。

**84. 你目前的求职状态如何？**

- 诚实告知你目前的状态。除非你真的收到 offer，否则不要杜撰。即使你没有拿到 offer, 你仍要在面试官面前表现的积极乐观。
...
- 我每天都在忙着找工作，已经得到了一些好的 offer。我希望能在六周内找到一份工作。
...
- 这个岗位非常有吸引力，我相信会有很多候选人跟我一样对这个岗位有兴趣。列举两个特长：**\_**。
...
### [#](https://interview2.poetries.top/docs/simply.html#第四个要点-聘用你-公司需付出多少)第四个要点：聘用你，公司需付出多少？
...
- 我在这个领域已经工作了 X 年，我也对这个行业的薪资有所了解。在此基础上，我想我可以基于这个岗位，要求￥**\_**。

**96. 你心目中的薪资水平是多少？**

- 我希望得到一份与我的潜力和未来贡献值相匹配的薪水。
- 在 3-5 年间能达到：**\_**。
- 在**\_**到**\_**之间，等我对岗位有了更具体的了解，我们可以把工资的范围再缩小。
- 根据我的调查，在**\_**和**\_**之间。另外我认为我的能力和经验可以拿最高档
- 如果能告诉我贵司对该岗位的薪资预算，对我们讨论这个问题会很有帮助。

**97. 在为期 6 个月培训期中，你是否能接受降低工资？**
...
**101. 你预期在未来 5 年内，薪资水平达到多少？**

- 增长 15-20%。
- 我希望能在未来 5 年内，磨练自己的能力，在职位和薪水上都有增长。
- 大概**\_**-**\_**。
- 由于我的职业生涯才刚刚开始，所以我有理由相信在五年内我会赚得更多，但我无法预测一个具体的数字。
- 这行变化很大，我认为我可以增长 50%甚至更多。
